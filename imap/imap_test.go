...
var fakeReply = map[string]string{
	...
	`# NOOP`:
		"# OK Success\r\n",
	`# UID FETCH 1:* (FLAGS X-GM-MSGID X-GM-THRID)`:
		`* 1 FETCH (X-GM-THRID 1371690017835349492 X-GM-MSGID 1371690017835349492 UID 46074 FLAGS (\Seen))`+"\r\n"+
	...
	`# UID FETCH 1:* (FLAGS INTERNALDATE RFC822.SIZE ENVELOPE X-GM-MSGID X-GM-THRID)`:
		...
		"# OK Success\r\n",
	`# UID FETCH 1:* (FLAGS INTERNALDATE RFC822.SIZE ENVELOPE BODY X-GM-MSGID X-GM-THRID X-GM-LABELS)`:
		`* 1 FETCH (X-GM-THRID 1371690017835349492 X-GM-MSGID 1371690017835349492 X-GM-LABELS () UID 46074 RFC822.SIZE 5700 INTERNALDATE "15-Jun-2011 13:45:39 +0000" FLAGS (\Seen) ENVELOPE ("Wed, 15 Jun 2011 13:45:35 +0000" "[re2-dev] Issue 40 in re2: Please make RE2::Rewrite public" ((NIL NIL "re2" "googlecode.com")) ((NIL NIL "re2-dev" "googlegroups.com")) ((NIL NIL "codesite-noreply" "google.com")) ((NIL NIL "re2-dev" "googlegroups.com")) NIL NIL NIL "<0-13244084390050003171-8842966241254494762-re2=googlecode.com@googlecode.com>") BODY ("TEXT" "PLAIN" ("CHARSET" "ISO-8859-1" "DELSP" "yes" "FORMAT" "flowed") NIL NIL "7BIT" 389 11))`+"\r\n"+
		...
		"# OK Success\r\n",
	`# UID FETCH 57046 BODY[1]`:
		`* 9 FETCH (UID 57046 BODY[1] {465}`+"\r\n"+
		...
		`)`+"\r\n"+
		"# OK Success\r\n",
	`# UID FETCH 57046 BODY[1.TEXT]`:
		`* 9 FETCH (UID 57046 BODY[1.TEXT] NIL)`+"\r\n"+
		"# OK Success\r\n",
	`# UID FETCH 57046 BODY[1.HEADER]`:
		`* 9 FETCH (UID 57046 BODY[1.HEADER] NIL)`+"\r\n"+
		"# OK Success\r\n",
	`# UID FETCH 57046 BODY[1.MIME]`:
		`* 146 FETCH (UID 57046 BODY[1.MIME] {74}`+"\r\n"+
		`Content-Type: text/plain; charset=ISO-8859-1; format=flowed; delsp=yes`+"\r\n"+
		``+"\r\n"+
		`)`+"\r\n"+
		"# OK Success\r\n",
	`# UID FETCH 57046 BODY[2]`:
		`* 146 FETCH (UID 57046 BODY[2] {914}`+"\r\n"+
		...
		`endar.</p></div>)`+"\r\n"+
		"# OK Success\r\n",
	`# UID FETCH 57046 BODY[2.TEXT]`:
		`* 9 FETCH (UID 57046 BODY[2.TEXT] NIL)`+"\r\n"+
		"# OK Success\r\n",
	`# UID FETCH 57046 BODY[2.HEADER]`:
		`* 9 FETCH (UID 57046 BODY[2.HEADER] NIL)`+"\r\n"+
		"# OK Success\r\n",
	`# UID FETCH 57046 BODY[2.MIME]`:
		`* 146 FETCH (UID 57046 BODY[2.MIME] {92}`+"\r\n"+
		`Content-Type: text/html; charset=ISO-8859-1`+"\r\n"+
		`Content-Transfer-Encoding: quoted-printable`+"\r\n"+
		``+"\r\n"+
		`)`+"\r\n"+
		"# OK Success\r\n",
	`# UID FETCH 57046 BODY[]`:
		`* 146 FETCH (UID 57046 BODY[] {4170}`+"\r\n"+
		...
		`)`+"\r\n"+
		"# OK Success\r\n",
	`# UID FETCH 57046 BODY[TEXT]`:
		`* 146 FETCH (UID 57046 BODY[TEXT] {1647}`+"\r\n"+
		`--bcaec501c5be15fc6504aedc6af3`+"\r\n"+
		`Content-Type: text/plain; charset=ISO-8859-1; format=flowed; delsp=yes`+"\r\n"+
		``+"\r\n"+
		`russcox@gmail.com, you have no events scheduled today Sun Oct 9, 2011.`+"\r\n"+
		...
		`)`+"\r\n"+
		"# OK Success\r\n",
	`# UID FETCH 57046 BODY[HEADER]`:
		`* 146 FETCH (UID 57046 BODY[HEADER] {2453}`+"\r\n"+
		`Delivered-To: rsc@swtch.com`+"\r\n"+
